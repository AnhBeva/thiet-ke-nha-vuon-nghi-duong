...
- Hiểu đúng bản chất của thiết kế theo thời gian và bảo trì.
...
Nhà vườn là công trình sống. Sau bàn giao, cây lớn lên, vật liệu cũ đi, nước bộc lộ lỗi, gia đình đổi nhu cầu và công chăm bắt đầu quyết định chất lượng.
...
Giai đoạn cây hồi phục, hệ tưới cần chỉnh, lỗi nước dễ lộ.

### 4.2. 1 năm

Có thể đánh giá qua đủ mùa nắng/mưa.

### 4.3. 3 năm

Cấu trúc cây bắt đầu rõ, cần tỉa tạo khung.

### 4.4. 5 năm

Vườn có chiều sâu nhưng rủi ro tán/rễ/ẩm cũng tăng.

### 4.5. 10 năm

Cần cải tạo chọn lọc, thay cây sai vai, nâng cấp vật liệu/hệ thống.

### 4.6. Lịch bảo trì

Phải chia theo cây, đất, nước, đèn, vật liệu và vệ sinh.
...
```mermaid
flowchart TD
  A["Dữ liệu đầu vào"] --> B["Phân tích Thiết Kế Theo Thời Gian Và Bảo Trì"]
  B --> C["Nguyên lý"]
  C --> D["Giải pháp"]
  D --> E["Kiểm tra lỗi"]
  E --> F["Đưa vào brief"]
...
Lập bảng phân tích thiết kế theo thời gian và bảo trì cho một khu vực cụ thể. Bảng gồm: hiện trạng, vấn đề, nguyên lý liên quan, giải pháp, rủi ro và tiêu chí kiểm tra.
